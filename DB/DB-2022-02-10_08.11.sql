...
--
-- Host: localhost:3306
-- Generation Time: Feb 10, 2022 at 01:11 AM
...
--
-- Table structure for table `akun_nilai`
--
...
CREATE TABLE `akun_nilai` (
  ...
  `matematika` decimal(10,0) NOT NULL,
  `biologi` decimal(10,0) NOT NULL,
  `fisika` decimal(10,0) NOT NULL,
  `kimia` decimal(10,0) NOT NULL,
  `file` varchar(256) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- AUTO_INCREMENT for table `akun_nilai`
--
ALTER TABLE `akun_nilai`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `akun_nilai`
--
ALTER TABLE `akun_nilai`
...
--
-- Constraints for table `pendaftar_status`
--
ALTER TABLE `pendaftar_status`
