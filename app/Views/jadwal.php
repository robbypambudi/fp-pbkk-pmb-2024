	...
	<div class="row my-3">
		<div class="col-lg-12">
			...
			<div class="alert alert-info" role="alert">
				Penerimaan Kadet Mahasiswa Unhan RI TA 2022/2023
			</div>
			...
			<table class="table table-striped">
				<tbody>
					...
					<tr>
						...
						<td>14 Februari 2022 - 14 Maret 2022</td>
					...
					<tr>
						<td>9</td>
						<td>Kedatangan Peserta Tes ke Unhan RI</td>
						<td>1 Juni 2022</td>
						<td>Kampus Unhan RI Kawasan IPSC Sentul Bogor Jabar</td>
					</tr>
					<tr>
						<td>10</td>
